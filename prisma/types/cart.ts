...
export type GetCartHook = {
  ...
  input: {}
  fetcherInput: { cartId?: string; wishlistId?: string }
...
export type GetCartHandler = GetCartHook & {
  body: { cartId?: string; wishlistId?: string }
}
...
export type DeleteItemHandler = DeleteItemHook & {
  body: { cartId: string; wishlistId?: string }
}
